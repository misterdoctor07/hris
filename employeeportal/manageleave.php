      ...
      <section class="wrapper">
        <div class="col-lg-12">
            <div class="content-panel">
              ...
              <h4><a href="?main"><i class="fa fa-arrow-left"></i> HOME</a> | <i class="fa fa-file-text"></i> LEAVE APPLICATION HISTORY <a href="dashboard.php?applyleave" style="float:right;" class="btn btn-primary"><i class="fa fa-plus"></i> Apply Leave</a></h4>              
            </div>
