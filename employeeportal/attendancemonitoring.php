...
// Safely retrieve parameters with defaults
$comp = isset($_GET['company']) ? mysqli_real_escape_string($con, $_GET['company']) : '';
$startdate = isset($_GET['startdate']) ? mysqli_real_escape_string($con, $_GET['startdate']) : date('Y-m-01');
$enddate = isset($_GET['enddate']) ? mysqli_real_escape_string($con, $_GET['enddate']) : date('Y-m-d');
