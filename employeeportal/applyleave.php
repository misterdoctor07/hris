...
<?php 
    ...
    $sqlRenewal = mysqli_query($con, "SELECT periodfrom, periodto FROM leave_credits WHERE idno='$userId'");
    if (mysqli_num_rows($sqlRenewal) > 0) {
        $row = mysqli_fetch_assoc($sqlRenewal);
...
<div class="centered-container">
    <form class="form-horizontal" method="GET" onsubmit="return SubmitDetails();" style="width: 100%; max-width: 500px;">
        ...
        <div class="content-panel">
            <div class="panel-heading d-flex align-items-center justify-content-between" style="position: relative;">
                <h4 class="mb-0 mx-auto text-center" style="flex: 1;">APPLY LEAVE</h4>
                <a href="manageleave.php" style="color: white; position: absolute; right: 15px;">
            ...
            <div class="panel-body"> 
                <div class="form-group mb-3" style="margin: 10px; margin-bottom: 30px;">
                    ...
                    <div class="custom-select-wrapper">
                        <select name="leavetype" class="form-control custom-select" required style="cursor: pointer;" onchange="updateCredits(this.value); checkSubmitButton(); toggleEOSelection(this.value);">
                ...
                <div class="form-group mb-3" id="eo-month-group" style="display: none; margin: 10px; margin-bottom: 30px;">
                    ...
                    <div class="custom-select-wrapper">
                        <select name="eo_month" class="form-control custom-select" style="cursor: pointer;">
                ...
                <div class="form-group mb-3" style="margin: 10px; margin-bottom: 30px;">
                    ...
                    <span id="renew-date-warning" style="color: red; display: none;">*You cannot file a Vacation Leave beyond your renewal date.</span>
                </div>
...
<script>
    ...
    function checkCredits() {
        ...
        let renewdateWarning = document.getElementById('renew-date-warning');
        ...
        let periodfrom = "<?=$periodfrom;?>";
        let periodto = "<?=$periodto;?>";
        let DatePeriodfrom = new Date(periodfrom);
        let DatePeriodto = new Date(periodto);
        ...
        //Condition for renewal restriction
        if (leaveType === 'VL') {
            let start = new Date(startDate.value);
            let from = new Date(DatePeriodfrom);
            let to = new Date(DatePeriodto);

            if (!startDate.value) {
                renewdateWarning.style.display = 'inline';
                startDate.style.borderColor = 'red';
                endDate.disabled = true;
                return false;
            }
            ...
            if (start < from || start > to) {
                ...
                renewdateWarning.style.display = 'none';
                startDate.style.borderColor = '';
                endDate.disabled = false;
            }
        } else {
            // Reset when switching away from VL
            renewdateWarning.style.display = 'none';
            startDate.style.borderColor = '';
            endDate.disabled = false;
        }
