...
if (isset($_GET['approved']) && isset($_GET['id'])) {
    ...
    $sqlUpdate = mysqli_query($con, "UPDATE missed_log_application SET applic_status='Approved - $approval [$datetime]' WHERE id='$id'");
...
if (isset($_GET['disapproved']) && isset($_GET['id'])) {
    ...
    $approval = "{$userDetails['lastname']} ({$userDetails['jobtitle']})";
    $datetime = date('M j, Y - g:i A');
    $sqlUpdate = mysqli_query($con, "UPDATE missed_log_application SET applic_status='Disapproved - $approval [$datetime]' WHERE id='$id'");
            ...
            <table class="table table-bordered table-striped table-condensed" id="hidden-table-info">
                <thead>
                    <tr>
                        ...
                        <th width="6%" style="text-align: center; vertical-align: middle; background-color:#20273a; color: white;">Employee ID</th>
                        <th width="10%" style="text-align: center; vertical-align: middle; background-color:#20273a; color: white;">Employee Name</th>
                        <th width="5%" style="text-align: center; vertical-align: middle; background-color:#20273a; color: white;">Department</th>
                        <th width="5%" style="text-align: center; vertical-align: middle; background-color:#20273a; color: white;">Work Area</th>
                        <th width="7%" style="text-align: center; vertical-align: middle; background-color:#20273a; color: white;">Date of Missed Time IN/OUT</th>
