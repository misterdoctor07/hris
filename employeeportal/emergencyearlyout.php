                ...
                <tbody>
                    ...
                    if (mysqli_num_rows($sqlEmployee) > 0) {
                        while ($company = mysqli_fetch_array($sqlEmployee)) {
                            ...
                            echo "<td align='center'>$company[type_EEO]</td>";
                            ...
                            <td align="center">
                                <?php if (strpos($company['eeo_status'], 'Approved') === false && strpos($company['eeo_status'], 'Disapproved') === false): ?> 
                                    <a href="?editeeo&id=<?= $company['id']; ?>" class="btn btn-primary btn-xs" title="Edit Emergency Early Out" <?= !$isPending ? 'disabled' : ''; ?>><i class='fa fa-edit'></i></a>
