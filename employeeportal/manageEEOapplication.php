            ...
            <ul class="sub">
             <?php if ($designation != 77  && $designation != 97 && $designation != 78 && $designation != 116): ?>
                ...
                <?php if (in_array($idno, $approvers) && $designation != 78 && $designation != 116 && $designation != 77 && $designation != 97): ?>
                  <li class="active"><a href="manageEEOapplication.php">EEO Requests 
...
<section id="main-content">
    ...
    <div class="content-panel">
        <div class="panel-heading">
            <h4><a href="?main" style="text-decoration: none;"><i class="fa fa-arrow-left"></i> HOME</a> | <i class="fa fa-file-text"></i> MANAGE EEO APPLICATION</h4>
        </div>
                    ...
                    if (mysqli_num_rows($sqlEmployee) > 0) {
                        ...
                        while ($company = mysqli_fetch_array($sqlEmployee)) {
                            ...
                            if(mysqli_num_rows ($sqlDepartment) > 0) {
                                ...
                                echo "<td style='text-align: center; vertical-align: middle;'>" . date('M j, Y', strtotime($company['dateEEO'])) . "</td>";
