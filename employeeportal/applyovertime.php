          ...
          <p class= "centered" style=" font-size:13px; color:white;"><?= $idno; ?></p>
           ...
           <li class="sub-menu active open">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="applyovertime.php" class="submenu-item" onclick="markNotifseen('overtime')" style="position: relative; display: inline-block;"> 
                        Apply Overtime 
              ...
              <?php if ($designation == 114): ?>
                <li><a href="?manageemployee"> Add Leave for Employee</a></li>
              <?php endif; ?>
            </ul>
          </li>
            <!-- ------------------------------------------------------------------------------- -->
      ...
      <section class="wrapper">
        <div class="col-lg-12">
            <div class="content-panel">
              ...
              <h4><a href="?main"><i class="fa fa-arrow-left"></i> HOME</a> | <i class="fa fa-calendar"></i> OVERTIME APPLICATION HISTORY <a href="dashboard.php?addovertime" style="float:right;" class="btn btn-primary"><i class="fa fa-plus"></i> Apply Overtime</a></h4>              
            </div>
                        ...
                        while ($company = mysqli_fetch_array($sqlEmployee)) {
                            ...
                            <td align="center">
                                <?php if (strpos($company['app_status'], 'Approved') === false && strpos($company['app_status'], 'Disapproved') === false): ?> 
                                    <a href="dashboard.php?editovertime&id=<?= $company['id']; ?>" class="btn btn-primary btn-xs" title="Edit Overtime" <?= !$isPending ? 'disabled' : ''; ?>><i class='fa fa-edit'></i></a>
