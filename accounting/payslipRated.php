<?php
    ...
    if (mysqli_num_rows($sqlBasicSalary) > 0) {
        ...
        $regHolWork = $salaryData['regholidayhrswork1'] ?? 0;
        $regHolWorkPay = $salaryData['regholidayamountwork1'] ?? 0;
        $regHolNotWork = $salaryData['regholidayhrsnotwork'] ?? 0;
        $regHolNotWorkPay = $salaryData['regholidayamountnotwork'] ?? 0;
        $regHolOT = $salaryData['regholidayotamount'] ?? 0;
        $regHolOTPay = $salaryData['regholidayotamount'] ?? 0;
        $specialNonWorkHol = $salaryData['spholidayhrs1'] ?? 0;
        $specialNonWorkHolPay = $salaryData['spholidayamount1'] ?? 0;
