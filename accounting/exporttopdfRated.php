...
ob_start();
include 'export_payslipRated.php'; // This should be the file with your HTML (with PHP variables)
$html = ob_get_clean();
...
$dompdf->stream("export_payslipRated.pdf", ["Attachment" => false]); // false = open in browser, true = download
?>