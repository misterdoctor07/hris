        ...
        <div class="panel-heading">
            ...
            <div class="row" style="margin-bottom: 20px;">
                <div class="col-md-3">
                    ...
                    <input type="date" id="fromDate" class="form-control form-control-sm" value="<?php echo isset($_GET['fromDate']) ? $_GET['fromDate'] : ''; ?>">
                </div>
                <div class="col-md-3">
                    <label for="toDate">To:</label>
                    <input type="date" id="toDate" class="form-control form-control-sm" value="<?php echo isset($_GET['toDate']) ? $_GET['toDate'] : ''; ?>">
                </div>
                <div class="col-md-2">
                ...
                while ($company = mysqli_fetch_array($sqlCompanies)) {
                    ...
                    while ($department = mysqli_fetch_array($sqlDepartments)) {
                        ...
                        $sqlEmployee = mysqli_query($con, "SELECT la.*, la.id as laid, ep.*, ed.*, d.department 
                            ...
                            ORDER BY 
                                CASE 
                                    WHEN la.appstatus NOT IN ('Pending', 'Cancelled', 'Disapproved') AND la.remarks NOT LIKE 'POSTED%' THEN 1 
                                    ELSE 2 
                                END,
                            la.datearray DESC");
