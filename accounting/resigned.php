                        ...
                        <table class="table table-bordered table-striped table-condensed">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center;">Date Resigned</th>
                                    ...
                                    if (mysqli_num_rows($sqlEmployee) > 0) {
                                        while ($employee = mysqli_fetch_array($sqlEmployee)) {
                                            ...
                                            echo "<tr data-year='" . date('Y', strtotime($employee['dateresigned'])) . "'>";
                                                echo "<td align='center'>$x.</td>"; // Use $x for numbering
                                                echo "<td align='center'>$employee[idno]</td>";
                                                echo "<td><strong>$employee[lastname]</strong>, $employee[firstname] $employee[middlename] $employee[suffix]</td>";
                                                echo "<td align='center'>" . date('M-d-Y', strtotime($employee['birthdate'])) . "</td>";
                                                echo "<td align='center'>$jobtitle</td>";
                                                echo "<td align='center'>$department</td>";
                                                echo "<td align='center'>" . date('m/d/Y', strtotime($employee['dateofhired'])) . "</td>";
                                                echo "<td align='center'>" . date('m/d/Y', strtotime($employee['dateresigned'])) . "</td>";
