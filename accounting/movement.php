<script type="text/javascript">
    ...
    <div class="row">
      <div class="col-lg-12">
      <h4 style="text-indent: 10px;"><a href="?main"><i class="fa fa-arrow-left"></i> BACK</a> | <i class="fa fa-road"></i> MOVEMENT TRACKER</h4>      
    </div>
    </div>
    <form class="form-horizontal style-form" method="GET">
      <input type="hidden" name="movement_tracker">
    <div class="col-lg-4 mt">
            <div class="content-panel">
              <div class="panel-heading">                
                <input type="submit" name="submit" class="btn btn-primary" value="Proceed" style="float:right;">
              <h4><i class="fa fa-user"></i> EMPLOYEE MOVEMENT</h4>            
            </div>
            <div class="panel-body">                                                              
                ...
                <div class="form-group">
                  <label class="col-sm-3 col-sm-3 control-label">SELECT YEAR</label>
                  <div class="col-sm-7">
                    <select name="year" class="form-control" required>
                      <option value=""></option>
                      <?php
                      for($year=date('Y');$year>=2019;$year--){
                            echo "<option value='$year'>CY $year</option>";
                      }
                      ?>                      
                    </select>
                  </div>
